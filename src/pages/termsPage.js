...
function TermsOfService() {
    ...
    return (
        <Grid container maxWidth={"xs"} justifyContent={"center"} >
            <Grid xs={12} md={7} margin={2} justifyContent={"center"} textAlign={"left"}>
                <Grid item margin={2} >
                    <Typography variant="h5" gutterBottom>
                        利用規約
                    </Typography>
                    <p>この利用規約（以下，「本規約」といいます。）は，ふくのう（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                </Grid>
                <Grid item margin={2}>
                    ...
                    <p>2当社は本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。</p>
                ...
                <Grid item margin={2}>
                    ...
                    <p>1.登録は無料です。年会費等も一切頂きません。</p>
                    <p>2.ユーザーは，本サービスの有料部分の対価として，当社が別途定め，本ウェブサイトに表示する利用料金を，当社が指定する方法により支払うものとします。</p>
                </Grid>
                <Grid item margin={2}>
                    <Typography variant='h6' gutterBottom>
                        第4条（禁止事項）
                ...
                <Grid item margin={2}>
                    ...
                    <Grid item margin={2}>
                        ...
                        <p>本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。</p>
                    </Grid>
